...
async function main() {
    try {
        ...
        // Mencari satu dokumen dalam koleksi 'pengguna' berdasarkan nama 'Radhi'.
        const byNama = await db.collection('pengguna').findOne({ nama: 'Radhian' });
        
        // Mencari satu dokumen dalam koleksi 'pengguna' berdasarkan ID objek tertentu.
        const byObjectID = await db.collection('pengguna').findOne({ _id: new ObjectId("694e87df4a09d6a299261ebc") });
